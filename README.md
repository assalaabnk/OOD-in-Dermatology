...
- See [this folder](./OOD%20methods) for code regarding the different OOD methods evaluated. We adopt Isolation Forest and OneClassSVM as baselines, and an AutoEncoder, Neural Network Softmax, and ODIN as state-of-the-art OOD methods. All models, training, and testing procedures, as well as hyperparameters, can be replicated following the code in this folder.
...
- See [this notebook - TBD](XX) For the evaluation and ranking of all OOD methods studied and our $RG$ metric comparion.
